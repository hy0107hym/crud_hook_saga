...
const itemSaga = [
    takeEvery(actionType.Items.GET_ITEMS_REQUEST, handleGetItem),
    takeEvery(actionType.Items.ADD_ITEMS_REQUEST, handleAddItem),
    takeEvery(actionType.Items.UPDATE_ITEMS_REQUEST , handleUpdateItem),
    takeEvery(actionType.Items.DELETE_ITEMS_REQUEST , handleDeleteItem),
    takeEvery(actionType.Items.PAGINATE_ITEMS_REQUEST , handlePaginateItem),
    takeEvery(actionType.Items.SEARCH_ITEMS_REQUEST , handleSearchItem)
]
